...
function init() {
  ...
  ensw = document.getElementById("enButton");
  jpsw = document.getElementById("jpButton");
  ...
  if (languageselected == 0) {
    ...
    ensw.classList.add("active");
  } else {
    ensw.classList.remove("active");
    jpsw.classList.add("active");
  }
